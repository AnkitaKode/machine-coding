/* Difference between Simple Method, Factory Method and Abstract Factory
A Simple Factory is a class that centralizes object creation. The client provides a parameter such as a string or enum, and the factory decides which concrete object to create. It hides the object creation logic from the client.

The Factory Method defines a method for creating an object, but lets subclasses decide which concrete object to create. This allows object creation to be extended without changing the existing client code.

The Abstract Factory provides an interface for creating families of related objects without specifying their concrete classes. It is useful when multiple related products need to be created together while ensuring they are compatible.*/
