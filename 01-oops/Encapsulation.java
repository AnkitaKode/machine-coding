...
/* Uses Access Specifierand  Getter Setter methods and aims Security
...
public class Encapsulation {
    public static void main(String[] args) {
        ...
        // Setting arbitrary value to speed works if public access specifier is used for currentSpeed variable which is not a good practice.
